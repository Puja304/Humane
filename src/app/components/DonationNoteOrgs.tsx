...
const DonationNoteOrgs = () => {
    ...
    return (
        ...
        className="w-screen h-screen bg-sky-900">
            <div className="donation-note-overlay sm:mx-20 md:mx-15 lg:mx-120 bg-note-bg/60 backdrop-blur-lg rounded-2xl p-10 flex flex-col items-center mx-10 sm:mt-10 md:mt-15 lg:mt-20 sm:py-15 md:py-20 lg:py-10">
